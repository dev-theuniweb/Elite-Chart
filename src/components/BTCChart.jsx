...
const BTCChart = ({ memberId, bearerToken, passBalance, betAmount, setBetAmount, selectedTrend, setSelectedTrend, onGameModeChange }) => {
  ...
  const [balance, setBalance] = useState(passBalance?.Point01 || 2000);
          ...
          <div className="trading-balance-section">
            ...
            <div className="trading-balance-value">
              ...
              <span className="gmchip-amount">
                {(passBalance?.Point01 || balance).toLocaleString('en-US', {

    ...
    <div className="btc-chart-container" ref={chartRef}>
      ...
      <div className="btc-price">
        <div>
          ...
          <span style={{ color: "#ff8c3e", fontWeight: 700, marginLeft: 8, marginRight: 8 }}>
              ...
              ? (
                <>
                  ...
                  <span className={
                    ...
                    {resultHistory[0].trend === "even" && <span className="btc-result-history-chevron">►</span>}
            ...
            {resultHistory.slice(1, 10).map((item, idx) => (
              <div key={idx} className="btc-result-history-item">
                ...
                <span className={
                  ...
                  {item.trend === "even" && <span className="btc-result-history-chevron">►</span>}

...
const BTCChart = () => {
  ...
  const latestX = width - rightLabelWidth / 2;
...
const pointArray = points;
  ...
  const xLabels = data
    ...
    .filter((label, i) => i % 5 === 0 && label.x >= leftLabelWidth && label.x <= width - rightLabelWidth); // every 5th point
      ...
      <svg width={width} height={height}>
        ...
        {yLabels.map((label, index) => (
          <g key={index}>
            <line
            x1={padding - 20}
            x2={width - 30} // or width - rightLabelWidth
            y1={label.y}
            y2={label.y}
            stroke="#333"
            strokeDasharray="4 2"
        ...
        {/* X-axis border - can remove*/}
        <rect
  x={leftLabelWidth}
  y={height - padding}
  width={width - leftLabelWidth}
  height={padding}
  fill="none"
  stroke="#fff"
  strokeWidth="1"
